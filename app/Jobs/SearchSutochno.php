...
use App\UseCase\Sutochno\Search;
...
class SearchSutochno implements ShouldQueue
{
    ...
    public function handle(Search $searchService, Proxy $proxy, FinishChecker $finishChecker): void
    {
        try {
            ...
            $searchService->search($proxy->getAllEnabledBySource('sutochno', 100), $searchRequest);
        } catch (\Throwable $e) {
